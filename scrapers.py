...
tournament_data_scraper.scrape(next_page_links, 'tournaments', tournament_links, True, 1, game_name, tournament_names, tournament_field_titles, False, tournament_field_values)
